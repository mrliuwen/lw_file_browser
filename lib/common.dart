class Common {
  ...
  String selectIcon(String ext) {
    ...
    switch (ext) {
      case '.ppt':
      case '.pptx':
        iconImg = 'assets/images/morbit_chat_fiile_icon_ppt.png';
        break;
      case '.doc':
      case '.docx':
        iconImg = 'assets/images/morbit_chat_fiile_icon_word.png';
        break;
      case '.xls':
      case '.xlsx':
        iconImg = 'assets/images/morbit_chat_fiile_icon_excel.png';
        break;
      case '.jpg':
      case '.jpeg':
      case '.png':
      ...
      case '.psd':
        ...
        break;
      case '.pdf':
        iconImg = 'assets/images/morbit_chat_fiile_icon_pdf.png';
        break;
      default:
